...
import GeomPolarArea from './GeomPolarArea';

import '../../stylesheets/demo.css';


export default class GeomPolarAreaDemo extends React.Component {
  ...
  render() {
    ...
    var layoutFn = GeomPolarArea.layout(aes, space, options);
